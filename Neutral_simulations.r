...
m.null.sr.a <- apply(null.ts.a,2,function(x){mean(x,na.rm=TRUE)})
m.null.sr.g <- apply(null.ts.g,2,function(x){mean(x,na.rm=TRUE)})
...
m.dev.sr.a <- apply(dev.ts.a,2,function(x){mean(x,na.rm=TRUE)})
m.dev.sr.g <- apply(dev.ts.g,2,function(x){mean(x,na.rm=TRUE)})
...
m.res.sr.a <- apply(res.ts.a,2,function(x){mean(x,na.rm=TRUE)})
m.res.sr.g <- apply(res.ts.g,2,function(x){mean(x,na.rm=TRUE)})
...
m.tran.sr.a <- apply(tran.ts.a,2,function(x){mean(x,na.rm=TRUE)})
m.tran.sr.g <- apply(tran.ts.g,2,function(x){mean(x,na.rm=TRUE)})
